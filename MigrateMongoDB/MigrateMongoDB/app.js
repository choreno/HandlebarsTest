var db = require('./model/db'),
    ...
    lr = new LineByLineReader('./sqlData/simple.sql', { encoding: 'utf8', skipEmptyLines: true }),
    //lr = new LineByLineReader('./sqlData/AllExpenditures_Updated.sql', { encoding: 'utf8', skipEmptyLines: true }),
...
lr.on('line', function (line) {
    ...
    var paymentDTTM = new Date(payYear, payMonth - 1);
